...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            desktop_companion::streaming_reply,
            desktop_companion::save_reading_check,
            desktop_companion::debug_list_windows,
            desktop_companion::debug_window_tree,
            desktop_companion::debug_find_input,
            desktop_companion::debug_find_buttons,
            ...
            project_workspace::convert_document_to_pdf,
